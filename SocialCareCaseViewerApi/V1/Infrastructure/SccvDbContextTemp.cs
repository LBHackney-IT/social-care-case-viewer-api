...
namespace SocialCareCaseViewerApi.V1.Infrastructure
{
    public class SccvDbContextTemp : ISccvDbContextTemp
    {
        ...
        public SccvDbContextTemp()
        {
            ...
            matProcessCollection = _mongoDatabase.GetCollection<BsonDocument>(Environment.GetEnvironmentVariable("SCCV_MONGO_COLLECTION_NAME_TEMP"));
        }
