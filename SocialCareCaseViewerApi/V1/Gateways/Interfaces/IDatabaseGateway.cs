...
namespace SocialCareCaseViewerApi.V1.Gateways.Interfaces
{
    public interface IDatabaseGateway
    {
        ...
        (List<Allocation>, int?, int) SelectAllocations(long mosaicId, long workerId, string workerEmail, long teamId, long allocationId, string sortBy, int cursor, string teamAllocationStatus, string status);
        ...
        void PatchPerson(PatchPersonRequest request);
