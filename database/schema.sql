...
--//TODO: TK create indexes

CREATE TABLE IF NOT EXISTS dbo.historical_dm_case_note_type
(
    note_type varchar(16) NOT NULL PRIMARY KEY,
    note_type_description varchar(80)
);

CREATE TABLE IF NOT EXISTS dbo.historical_worker
(
    ...
    CONSTRAINT "AK_historical_workers_system_user_id" UNIQUE (system_user_id)
);

CREATE TABLE IF NOT EXISTS dbo.historical_case_note
(
    id bigint NOT NULL GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    person_id bigint NOT NULL,
    ...
    note text,
    CONSTRAINT "FK_historical_case_note_historical_worker_created_by" FOREIGN KEY (created_by)
        REFERENCES dbo.historical_worker (system_user_id) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE RESTRICT
);

CREATE TABLE IF NOT EXISTS dbo.historical_dm_visit
(
    ...
    CONSTRAINT "FK_historical_dm_visit_historical_worker_worker_id" FOREIGN KEY (worker_id)
        REFERENCES dbo.historical_worker (id) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE RESTRICT
);
