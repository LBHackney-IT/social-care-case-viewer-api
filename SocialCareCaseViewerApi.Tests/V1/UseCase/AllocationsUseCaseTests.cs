...
namespace SocialCareCaseViewerApi.Tests.V1.UseCase
{
    ...
    public class AllocationsUseCaseTests
    {
        ...
        public void ListAllocationsByWorkerEmail()
        {
            ...
            _mockDatabaseGateway.Setup(x => x.SelectAllocations(0, 0, "test@example.com", 0, 0, null, 0, null, null))
                .Returns((gatewayResponse, 0, 1));
        ...
        public void ListAllocationsByTeamIdReturnsExpectedList()
        {
            ...
            _mockDatabaseGateway.Setup(x => x.SelectAllocations(0, 0, null, 10, 0, null, 0, null, null))
                .Returns((gatewayResponse, 0, 1));
        ...
        public void ListAllocationsByMosaicIdReturnsExpectedList()
        {
            ...
            _mockDatabaseGateway.Setup(x => x.SelectAllocations(3, 0, null, 0, 0, null, 0, null, null))
                .Returns((gatewayResponse, 0, 1));
        ...
        public void ListAllocationsByWorkerIdReturnsExpectedList()
        {
            ...
            _mockDatabaseGateway.Setup(x => x.SelectAllocations(0, 5, null, 0, 0, null, 0, null, null))
                .Returns((gatewayResponse, 0, 1));
        ...
        public void ExecuteCallsSelectAllocationMethodOnGatewayWithSortPropertyWhenProvided()
        {
            ...
            _mockDatabaseGateway.Setup(x => x.SelectAllocations(It.IsAny<long>(), It.IsAny<int>(), It.IsAny<string>(), It.IsAny<int>(), It.IsAny<int>(), It.IsAny<string>(), It.IsAny<int>(), It.IsAny<string>(), It.IsAny<string>())).Returns((new List<Allocation>(), 0, 1));

            _allocationsUseCase.Execute(request);

            _mockDatabaseGateway.Verify(x => x.SelectAllocations(request.MosaicId, 0, null, request.TeamId, 0, request.SortBy, 0, request.TeamAllocationStatus, request.Status), Times.Once);
        }
        ...
        public void ExecuteCallsSelectAllocationMethodOnGatewayWithCursorWhenProvided()
        {
            ...
            _mockDatabaseGateway.Verify(x => x.SelectAllocations(request.MosaicId, 0, null, request.TeamId, 0, null, request.Cursor, request.TeamAllocationStatus, request.Status), Times.Once);
        }
        ...
        public void ListAllocationsByTeamIdWithStatusReturnsExpectedList()
        {
            ...
            _mockDatabaseGateway.Setup(x => x.SelectAllocations(0, 0, null, 10, 0, null, 0, null, "closed"))
                .Returns((gatewayResponse, 0, 1));
