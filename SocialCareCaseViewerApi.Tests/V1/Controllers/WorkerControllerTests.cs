...
namespace SocialCareCaseViewerApi.Tests.V1.Controllers
{
    ...
    public class WorkerControllerTests
    {
        ...
        [Test]
        public void CreateWorkerReturns400WhenNoTeam()
        {
            var createWorkerRequest = TestHelpers.CreateWorkerRequest(team: "");
            var response = _workerController.CreateWorker(createWorkerRequest) as ObjectResult;
        ...
        [Test]
        public void CreateWorkerReturns400WhenTeamLongerThan200Character()
        {
            var createWorkerRequest = TestHelpers.CreateWorkerRequest(team: _faker.Random.String2(201));
            var response = _workerController.CreateWorker(createWorkerRequest) as ObjectResult;
